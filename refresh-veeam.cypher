...
WITH * ,split(vmobject.ObjectRef,'.')[1] as vmid,trim(apoc.text.regreplace(split(sessionvm.Name,'@')[0],regex1,'')) as cleanedname where sessionvm.Type='BackupTaskSessionReference'
